...
public class planedRecorsdDelet extends JDialog implements ItemListener {
	...
	public planedRecorsdDelet() throws Exception{
		pan = new AllRecordsPanel(new Dimension(600, 200), false);
		//rec = new RecordsPanel(new Dimension(600, 200), 0, 0, 0, 0, 0, 0);
		btnPanel = new JPanel();
		setTitle("Tervezett rekord törlése");
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource().equals(Keres)){
			try {
				...
				pan.rec = new RecordsPanel(dim, FYear,  FMonth, FDay, TYear, TMonth, TDay, false);
				add(rec.scrollPane1);
				validate();
				repaint();
